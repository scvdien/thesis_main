...
if ($requestedRole !== $dispensingRole) {
    mss_page_redirect('dispensing-records.php?role=' . $dispensingRole);
}
?><!doctype html>
<html lang="en">
<head>
  ...
  <div id="wrapper">
    <div id="content-area">
      <aside id="sidebar">
        ...
        <div class="menu" id="roleMenu">
          <a href="dispensing-records.php?role=<?= htmlspecialchars($dispensingRole, ENT_QUOTES, 'UTF-8') ?>" class="active"><i class="bi bi-journal-medical"></i>Dispensing Records</a>
        </div>
      </aside>

      <div class="sidebar-backdrop" id="sidebarBackdrop"></div>

      <main id="main" class="resident-records-main">
        <div class="topbar">
          <div class="d-flex align-items-center gap-3">
            ...
            <div class="page-intro">
              <h4 class="mb-0 text-primary">Dispensing Records</h4>
            </div>
          </div>
        </div>
        ...
        <div class="modal-body pt-0">
          <div class="record-history">
            <div class="record-history__head">
              ...
              <span class="record-history__count" id="recordHistoryCount">0 records</span>
            </div>

            <div class="record-history__table-wrap">
              <table class="record-history__table">
                <thead>
                  <tr>
                    <th>Date</th>
                    <th>Medicine</th>
                ...
                <tbody id="recordHistoryBody">
                  <tr>
                    <td colspan="4" class="record-history__empty">No medication history yet.</td>
                  </tr>
                </tbody>
              </table>
            </div>
