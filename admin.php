...
<link rel="stylesheet" href="assets/css/admin-style.css?v=<?= htmlspecialchars($adminDashboardStyleVersion, ENT_QUOTES, 'UTF-8') ?>">
</head>
...
<div id="wrapper">
  ...
  <script src="assets/js/admin-dashboard-scripts.js?v=<?= htmlspecialchars($adminDashboardScriptVersion, ENT_QUOTES, 'UTF-8') ?>"></script>
