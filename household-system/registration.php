...
<head>
  ...
  <style>
    html.is-offline-mode #openStaffAccountSettingsBtn {
      display: none !important;
    }
  </style>
  <script>
    (function () {
      var isOffline = !navigator.onLine || (function () {
        try {
          return sessionStorage.getItem('cabarian_offline_session_active') === 'true';
        } catch (e) {
          return false;
        }
      })();
      ...
      if (isOffline) {
        document.documentElement.classList.add('is-offline-mode');
      }
    })();
  </script>
</head>
